...
import { createTypePointTemplate, createCitiesTemplate, createOfferPointTemplate} from './edit-point';
    ...
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text"
          name="event-start-time" value="${dateBegin !== null ? `${dayjs(dateBegin).format('DD/MM/YY')} ${dayjs(dateBegin).format('HH:mm')}` : ''}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-1">To</label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text"
          name="event-end-time" value="${dateEnd !== null ? `${dayjs(dateEnd).format('DD/MM/YY')} ${dayjs(dateEnd).format('HH:mm')}` : ''}">
      </div>
